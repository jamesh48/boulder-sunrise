...
interface MoonCloudsProps {
  sx?: SxProps;
}

const MoonCloudsIcon = (props: MoonCloudsProps) => {
  return (
      ...
      >
        <g>
          <g>
            ...
            />
            <polygon
              points="24.343,15.226 24.811,14.196 25.924,13.999 25.09,13.234 25.245,12.113 24.262,12.672 23.245,12.178
			23.472,13.287 22.688,14.101 23.811,14.229 		"
            />
            <polygon
              points="1.868,12.458 2.668,12.047 3.46,12.472 3.316,11.585 3.965,10.963 3.077,10.825 2.685,10.016 2.281,10.82
			1.39,10.939 2.029,11.573 		"
            />
            <polygon
              points="20.039,10.454 20.404,11.137 20.725,10.43 21.488,10.296 20.916,9.772 21.023,9.004 20.348,9.386 19.65,9.047
			19.806,9.808 19.268,10.365 		"
            />
            <polygon
              points="23.715,8.424 23.939,8.844 24.136,8.411 24.605,8.327 24.254,8.005 24.318,7.535 23.904,7.771 23.479,7.562
			23.572,8.028 23.242,8.37 		"
            />
            <polygon
              points="6.838,5.599 7.062,6.019 7.259,5.585 7.728,5.501 7.377,5.179 7.442,4.709 7.028,4.944 6.601,4.736 6.696,5.201
			6.365,5.544 		"
            />
          </g>
        </g>
